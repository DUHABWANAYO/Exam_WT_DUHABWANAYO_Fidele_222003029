...
<section> 
  ...
  <form method="post" action="withdrawals.php">
    ...
    <input type="Date" id="WithdrawalDate" name="WithdrawalDate" required><br><br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO withdrawals(WithdrawalID, UserID, Amount, WithdrawalDate) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("isss", $WithdrawalID,$UserID, $Amount, $WithdrawalDate);
...
<head>
    ...
    <title>Detail information of Withdrawals</title>
    <style>
        table {
            width: 80%;
...
<body><center>
    <center><h1><u>Withdrawal Table</u></h1></center>
    <table border="2">
        <tr>
            <th>WithdrawalID</th>
            <th>UserID</th>
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<tr>
                        ...
                        <td><a style='padding:4px' href='Delete_Withdrawals.php?WithdrawalID=$WithdrawalID'>Delete</a></td> 
                        <td><a style='padding:4px' href='Update_Withdrawals.php?WithdrawalID=$WithdrawalID'>Update</a></td> 
                    </tr>";
                }
            } else {
