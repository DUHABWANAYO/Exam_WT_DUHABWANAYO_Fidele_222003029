...
<title>Index of cryptocurrency exchange platform Page</title>
<style>
  body {
    margin: 0;
    padding: 0;
    font-family: Arial, sans-serif;
    background: url('./crypto currency exchange image.png') center/cover no-repeat;
...
<div class="overlay">
  <div class="container">
    ...
    <p><i>Cryptocurrency Exchange Platform</i></p>
